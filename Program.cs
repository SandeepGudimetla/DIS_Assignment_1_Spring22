...
by doing this assignment i have learned lot about strings and character arrays and how to write programme to get different outputs. it took approximately 10 hrs
within span of 3 days to complete these questions.
*/
using System;


namespace Sandeep_U35966923
{
    class Program
    {
        ...
        */
        ...
        private static string RemoveVowels(string s)
        {
            try
            {
                ...
                {
                    // checking for vowels and replacing them with empty space in the output (Final String)
       ...
       */
        ...
        private static bool ArrayStringsAreEqual(string[] bulls_string1, string[] bulls_string2)
        {
            try
            {
                ...
                string string1 = "";
                string string2 = "";
                int length1 = bulls_string1.Length;
                int length2 = bulls_string2.Length;
                // combing the elements of the array
                // Converting the combined elements to upper case for comparision
                for (int j = 0; j < length1; j++)
                {
                    string1 += bulls_string1[j].ToUpper();
                }
                for (int j = 0; j < length2; j++)
                {
                    string2 += bulls_string2[j].ToUpper();
                }
        ...
        */
        ...
        private static int DiagonalSum(int[,] bulls_grid)
        {
            try
            {
                ...
                for (int j = n - 1; j >= 0; j--)
                {
                    //calculating the sum of the second diagnol
                    int i = n - j - 1;
                    if (i != j)
                    {
                        sum += bulls_grid[i, j];
